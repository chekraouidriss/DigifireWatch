...
// Updated to use environment.apiUrl — flip to production with one build flag
...
import { User, AuthResponse, LoginPayload, SignupPayload, UserRole } from '../models/user.model';
...
export class AuthService {
  ...
  signup(payload: SignupPayload): Observable<AuthResponse> {
    return this.http
      .post<AuthResponse>(`${this.API}/auth/signup`, payload)
      .pipe(tap(res => this.persist(res)));
  }
